...
class ProductionCompaniesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create production_company" do
    assert_difference('ProductionCompany.count') do
      post production_companies_url, params: { production_company: { address: @production_company.address, name: @production_company.name, website: @production_company.website } }
    end
  ...
  test "should update production_company" do
    patch production_company_url(@production_company), params: { production_company: { address: @production_company.address, name: @production_company.name, website: @production_company.website } }
